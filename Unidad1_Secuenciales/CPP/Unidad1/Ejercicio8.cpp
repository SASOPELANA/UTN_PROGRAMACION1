...
int main()
{
    ...
    */
    ...
    int importe_venta, importe_descuento, descuento_aplicado;

    cout << "Diguite el importe de una venta sin descuento: $";
    cin >> importe_venta;
    cout << "Diguite el importe de la venta con descuento aplicado: $";
    cin >> importe_descuento;
    descuento_aplicado = ((importe_venta - importe_descuento) * 100) / importe_venta;
    cout <<  endl;
    cout << "El porcentaje del descuento aplicadoo es del: " << descuento_aplicado << "%" << endl;
