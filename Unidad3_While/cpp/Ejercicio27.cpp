/*
    27 Una universidad dispone de diez aulas para acomodar a una cantidad de asistentes a una charla. Cada aula tiene una capacidad total de 60 personas. 
...
int main(){
    ...
    cout << "Las aulas que se necesitan: " << aulas << endl;
